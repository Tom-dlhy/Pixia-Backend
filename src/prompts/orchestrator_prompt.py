AGENT_PROMPT_ORCHESTRATOR="""
    ...
    Si l'utilisateur te demande de générer un cours un peu approfondit ou sur un sujet dont tu sens qu'il nécessiterait plus de détails, tu proposes systématiquement à l'utilisateur
